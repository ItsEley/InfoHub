       ...
       <div class="list-group list-group-flush">
        <a href="dashboard.php" class="list-group-item waves-effect">
         ...
         <a href="#" class="list-group-item list-group-item-action waves-effect"  data-toggle="modal" data-target="#modalRegisterForm">
          ...
          <i class="fas fa-users"></i> View Admin/s</a>
        ...
        <a href="view_userfile.php" class="list-group-item list-group-item-action waves-effect">
          ...
          <i class="fas fa-chalkboard-teacher"></i> Admin Logs</a>
              <a href="user_log.php" class="list-group-item list-group-item-action active waves-effect">
...
<!-- 
    ...
    <a href="add_document.php"><button type="button" class="btn btn-info"><i class="fas fa-chevron-circle-left"></i>  View Documents</button></a>
    </div>
...
<?php } ?>
  ...
  <p>All right Reserved &copy; <?php echo date('Y');?> Capstone BSIT 3301 BA</p>
    </div>
    <!--/.Copyright-->
